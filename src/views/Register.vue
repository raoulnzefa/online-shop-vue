      ...
      <div class="md:flex w-full">
        ...
        <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
          <div class="text-center mb-10">
            <h1 class="font-bold text-3xl text-gray-900">Ro‘yxatdan o‘tish</h1>
          </div>
          <div v-if="validErr" class="notifValid border-red-100 bg-red-50 text-red-800">
            <b>Xatolik!</b>
            <p>{{ validErr }}</p>
          </div>
          <div>
            <div class="flex -mx-3">
              <div class="min-w-full px-3 mb-5">
                <label for="" class="text-xs font-semibold px-1">Ism sharfingniz</label>
                <div class="flex">
                  <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg" /></div>
                  <input v-model="form.name" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="FIO">
                </div>
              </div>
            </div>
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-5">
                ...
                <div class="flex">
                  <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg" /></div>
            ...
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-5">
                <label for="" class="text-xs font-semibold px-1">Telefoni</label>
                <div class="flex">
                  <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg" /></div>
                  <input v-model="form.phone" type="phone" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com">
                </div>
              </div>
            </div>
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-12">
                <label for="" class="text-xs font-semibold px-1">Parol</label>
                <div class="flex">
                  <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg" /></div>
            ...
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-12">
                <label for="" class="text-xs font-semibold px-1">Parolni takrorlang</label>
                <div class="flex">
                  <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg" /></div>
                  <input v-model="form.password_confirmation" type="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************">
                </div>
              </div>
            </div>
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-5">
                <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" @click="register">Ro'yhatdan o'tish</button>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    register() {
      if (this.validation()) {
        axios.post('https://online-shop.api/api/register', this.form)
          .then(res => {
            console.log(res)
    ...
    validation() {
      if (!this.form.name || !this.form.email || !this.form.password || !this.form.password_confirmation || !this.form.phone) {
        console.log(this.form)
        this.validErr = 'Barcha maydonlar to\'ldirilishi shart'
        return false
      } else if (this.form.password !== this.form.password_confirmation) {
        console.log(this.form)

        this.validErr = 'Parol bir xilligini tekshiring'
        return false
      } else {
        this.validErr = ''
        return true
